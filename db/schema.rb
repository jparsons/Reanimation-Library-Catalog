...
ActiveRecord::Schema.define(:version => 20120611205902) do
  ...
  create_table "digital_assets_works", :id => false, :force => true do |t|
    t.integer "digital_asset_id"
    t.integer "work_id"
  end
  ...
  create_table "image_types_items", :id => false, :force => true do |t|
    t.integer "image_type_id"
    t.integer "item_id"
  end
